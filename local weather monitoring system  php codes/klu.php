...
$selectSQL1 = "select * from data where device='KLU' and attribute='temperature' order by timestamp desc limit 1;";
$selectRes1=$con->query($selectSQL1);

$selectSQL2 = "select * from data where device='KLU' and attribute='humidity' order by timestamp desc limit 1;";
$selectRes2=$con->query($selectSQL2);

$selectSQL3 = "select * from data where device='KLU' and attribute='Rainfall' order by timestamp desc limit 1;";
$selectRes3=$con->query($selectSQL3);

$selectSQL4 = "select * from data where device='KLU' and attribute='Pressure' order by timestamp desc limit 1;";
